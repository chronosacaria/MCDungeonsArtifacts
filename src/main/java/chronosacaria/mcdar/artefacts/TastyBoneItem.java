    ...
    public ActionResult useOnBlock (ItemUsageContext itemUsageContext){
        ...
        if (world.isClient){
            ...
            if (itemUsageContextPlayer != null){
                ...
                if (SummoningHelper.summonSummonableEntity(SummonedEntityRegistry.TASTY_BONE_WOLF_ENTITY.create(world), itemUsageContextPlayer, itemUsageContext.getBlockPos())) {
