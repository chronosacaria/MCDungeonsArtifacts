...
public class FlamingQuiverItem extends ArtefactQuiverItem{
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext tooltipContext){
        tooltip.add(Text.translatable("tooltip_info_item.mcdar.flaming_quiver_1").formatted(Formatting.ITALIC));
        tooltip.add(Text.translatable("tooltip_info_item.mcdar.flaming_quiver_2").formatted(Formatting.ITALIC));
    }
}
